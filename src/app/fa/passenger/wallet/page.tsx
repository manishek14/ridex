      ...
      <div className="max-w-[1000px] mx-auto space-y-8 pb-10" dir={isFa ? "rtl" : "ltr"}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            {/* Payment Methods */}
            <div className="p-6 rounded-[28px] bg-bg2 border border-bdr">
              <h3 className="text-sm font-black text-fg uppercase tracking-widest mb-4 flex items-center gap-2">
                <CreditCard size={16} className="text-fg4" />
                {isFa ? "روش‌های پرداخت" : "Payment Methods"}
              </h3>
              <div className="space-y-3">
                <div className="p-4 rounded-2xl bg-glass border border-bdr flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs font-bold text-fg2">**** ۴۳۲۱</span>
                  </div>
                  <div className="w-2 h-2 rounded-full bg-green-500" />
                </div>
                <button className="w-full py-3 rounded-xl border border-dashed border-bdr2 text-xs font-bold text-fg4 hover:text-fg hover:border-fg transition-all">
            ...
            <div className="p-6 rounded-[28px] bg-glass border border-bdr">
              <div className="flex items-start gap-3">
                <Info size={20} className="text-fg4 mt-0.5" />
                <p className="text-[11px] text-fg4 leading-relaxed">
                  {isFa 
