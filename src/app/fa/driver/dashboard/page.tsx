      ...
      <div className="space-y-6 max-w-[1400px] mx-auto pb-10" dir={isFa ? "rtl" : "ltr"}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <motion.div 
            ...
            className="p-6 rounded-[24px] bg-[var(--fg)] text-[var(--bg)] flex flex-col justify-between relative overflow-hidden group"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="p-6 rounded-[24px] bg-[var(--bg2)] border border-[var(--bdr)] flex-1">
              <div className="flex items-center justify-between mb-6">
                ...
                <Bell size={18} className="text-[var(--fg4)]" />
              </div>
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-center gap-4 p-3 rounded-xl hover:bg-[var(--glass)] transition-colors cursor-pointer border border-transparent hover:border-[var(--bdr)]">
                    <div className="text-xl">{notif.icon}</div>
                    <div className="flex-1">
                      <p className="text-sm font-bold text-[var(--fg)]">{notif.title}</p>
                      <p className="text-[10px] text-[var(--fg4)]">{notif.time}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            {/* Quick Actions */}
            <div className="p-6 rounded-[24px] bg-[var(--glass)] border border-[var(--bdr)]">
               <h3 className="text-sm font-black text-[var(--fg4)] uppercase tracking-widest mb-4">
                 {isFa ? "دسترسی سریع" : "Quick Actions"}
               </h3>
               <div className="grid grid-cols-2 gap-3">
                 <button className="p-3 rounded-xl bg-[var(--bg2)] border border-[var(--bdr)] text-xs font-bold text-[var(--fg2)] hover:text-[var(--fg)] hover:border-[var(--bdr2)] transition-all">
