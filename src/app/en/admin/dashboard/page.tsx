      ...
      <div dir={isFa ? "rtl" : "ltr"}>
        ...
        <div className="grid grid-cols-2 xl:grid-cols-4 gap-3 mb-6">
          {statCards.map((s, i) => (
            <Card key={i} hover>
              ...
              <div className="text-[22px] font-black text-[var(--fg)] leading-none mb-1">
                {s.value}
              </div>
              <p className="text-[11px] text-[var(--fg3)]">{s.label}</p>
            </Card>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
          ...
          <div className="p-5 rounded-2xl bg-[var(--glass)] border border-[var(--bdr)]">
            <p className="text-sm font-bold text-[var(--fg)] mb-4">
                ...
                return (
                  <div key={ride.id} className="flex items-center gap-3 py-2 border-b border-[var(--bdr)] last:border-none">
                    ...
                    <div className="text-right">
                      <p className="text-[12px] font-bold text-[var(--fg)]">
