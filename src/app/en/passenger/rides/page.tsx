// src/app/en/passenger/rides/page.tsx
"use client";
  ...
  return (
    <DashboardLayout locale={locale} pageTitle={isFa ? "سفرهای من" : "My Rides"}>
      <div className="max-w-2xl" dir={isFa ? "rtl" : "ltr"}>
        {/* Filter tabs */}
        <div className="flex gap-1.5 mb-5 p-1 rounded-xl bg-glass border border-bdr w-fit">
          {filters.map((f) => (
            <button
              key={f.value}
        ...
        {filtered.length === 0 ? (
          <div className="text-center py-16">
            ...
            <Link
              ...
              className="inline-block mt-4 px-4 py-2 rounded-xl bg-fg text-bg text-sm font-bold no-underline"
              style={{ fontFamily: isFa ? "Vazirmatn, sans-serif" : undefined }}
            >
            ...
            {filtered.map((ride) => {
              ...
              return (
                <Link
                  ...
                  className="block p-4 rounded-2xl bg-glass border border-bdr hover:bg-glass2 hover:border-bdr2 transition-all duration-150 no-underline"
                >
                  <div className="flex items-start justify-between gap-3 mb-3">
                    <div className="flex items-center gap-2.5">
                      <div className="w-10 h-10 rounded-xl bg-glass2 flex items-center justify-center text-xl">
                        {typeInfo.icon}
                      </div>
                      <div>
                        <p
                        ...
                        <p className="text-[11px] text-fg4 flex items-center gap-1">
                          <Clock size={10} />
                    ...
                    <div className="text-right">
                      <p
                        className="text-[15px] font-extrabold text-fg"
                        style={{ fontFamily: isFa ? "Vazirmatn, sans-serif" : undefined }}
                      >
                  ...
                  <div className="flex flex-col gap-1.5 px-1">
                    <div className="flex items-center gap-2">
                      ...
                      <p
                        className="text-[12px] text-fg3 truncate"
                        style={{ fontFamily: isFa ? "Vazirmatn, sans-serif" : undefined }}
                      >
                        {ride.origin.address}
                      </p>
                  ...
                  {ride.rating && (
                    <div className="mt-2.5 flex items-center gap-1 text-yellow-400">
                      ...
                      <span className="text-[10px] text-fg4 mr-0.5">
