// src/app/en/passenger/booking/page.tsx
"use client";
  ...
  return (
    <DashboardLayout locale={locale} pageTitle={isFa ? "رزرو سفر" : "Book a Ride"}>
      <div className="max-w-2xl" dir={isFa ? "rtl" : "ltr"}>
              ...
              <button
                ...
                className={`flex flex-col items-center gap-1.5 py-3 px-2 rounded-xl border transition-all duration-200 ${
                  selectedType === rt.type
                    ...
                    : "bg-glass border-bdr text-fg3 hover:border-bdr2 hover:text-fg"
                }`}
              >
        ...
        {/* Locations */}
        <div className="p-5 rounded-2xl bg-glass border border-bdr mb-4 space-y-3">
          ...
          <div className="h-px bg-bdr mx-11" />
          <div className="flex items-center gap-3">
        ...
        {originText && destText && (
          <motion.div
            ...
            className="p-4 rounded-2xl bg-glass border border-bdr mb-4 grid grid-cols-3 gap-3"
          >
            {[
              ...
              <div key={i} className="text-center">
                <div className="flex items-center justify-center gap-1 text-fg3 mb-1">
                  {info.icon}
                  <span
                    className="text-[10px]"
                    style={{ fontFamily: isFa ? "Vazirmatn, sans-serif" : undefined }}
        ...
        {isSearching && (
          <motion.div
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
            className="mt-4 p-4 rounded-xl bg-glass border border-bdr flex items-center gap-3"
          >
            <div className="w-8 h-8 border-2 border-fg border-t-transparent rounded-full animate-spin flex-shrink-0" />
            <p
