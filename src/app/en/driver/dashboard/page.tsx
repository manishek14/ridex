// src/app/en/driver/dashboard/page.tsx
"use client";
...
import { TrendingUp, Star, Car, Clock, Power } from "lucide-react";
import {
  ...
  return (
    <DashboardLayout locale={locale} pageTitle={isFa ? "داشبورد راننده" : "Driver Dashboard"}>
      <div dir={isFa ? "rtl" : "ltr"}>
        ...
        <div className="flex items-center justify-between mb-6 p-5 rounded-2xl bg-glass border border-bdr">
          <div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
          {stats.map((s, i) => (
            <Card key={i} hover>
              ...
              <div className="text-[22px] font-black text-fg leading-none mb-1" style={{ fontFamily: isFa ? "Vazirmatn, sans-serif" : undefined }}>
                {s.value}
              </div>
        ...
        <div className="p-5 rounded-2xl bg-glass border border-bdr mb-6">
          <p className="text-sm font-bold text-fg mb-4" style={{ fontFamily: isFa ? "Vazirmatn, sans-serif" : undefined }}>
          ...
          <div className="p-5 rounded-2xl bg-glass border border-bdr">
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <div key={i} className="p-3 rounded-xl bg-glass2">
                  <p className="text-[10px] text-fg4 mb-1" style={{ fontFamily: isFa ? "Vazirmatn, sans-serif" : undefined }}>{item.label}</p>
                  <p className="text-sm font-semibold text-fg" style={{ fontFamily: isFa ? "Vazirmatn, sans-serif" : undefined }}>{item.value}</p>
                </div>
              ))}
            </div>
          </div>
