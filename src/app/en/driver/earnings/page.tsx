// src/app/en/driver/earnings/page.tsx
"use client";
      ...
      <div className="max-w-2xl" dir={isFa ? "rtl" : "ltr"}>
        ...
        <div className="grid grid-cols-3 gap-3 mb-6">
          {[
            ...
            <Card key={i} hover>
              <p className="text-[11px] text-fg4 mb-2" style={{ fontFamily: isFa ? "Vazirmatn, sans-serif" : undefined }}>{s.label}</p>
              <p className="text-[18px] font-black text-fg leading-none mb-1" style={{ fontFamily: isFa ? "Vazirmatn, sans-serif" : undefined }}>{s.value}</p>
        ...
        <div className="p-5 rounded-2xl bg-glass border border-bdr">
          ...
          <div className="flex flex-col gap-2">
            {completedRides.slice(0, 5).map((r) => (
              <div key={r.id} className="flex items-center justify-between py-2.5 border-b border-bdr last:border-none">
                <div>
                  <p className="text-[13px] font-semibold text-fg" style={{ fontFamily: isFa ? "Vazirmatn, sans-serif" : undefined }}>
                    {r.destination.address}
                  </p>
                  <p className="text-[11px] text-fg4">{r.distance} km · {r.duration} min</p>
                </div>
