    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4" dir={isFa ? "rtl" : "ltr"}>
      {stats.map((stat, i) => (
        <motion.div
          ...
          className="p-5 rounded-2xl bg-bg2 border border-bdr hover:border-bdr2 transition-all duration-300 group"
        >
          <div className="flex items-center justify-between mb-4">
            <div className="w-10 h-10 rounded-xl bg-glass border border-bdr flex items-center justify-center group-hover:scale-110 transition-transform">
              {stat.icon}
            </div>
            <span className="text-[10px] font-black px-2 py-1 rounded-lg bg-glass text-fg3 uppercase tracking-widest">
              {stat.trend}
            </span>
          </div>
          <div>
            <p className="text-xs font-bold text-fg4 mb-1" style={{ fontFamily: isFa ? "Vazirmatn, sans-serif" : undefined }}>
              {stat.label}
            </p>
            <div className="flex items-baseline gap-1">
              ...
              <span className="text-[10px] font-bold text-fg4 uppercase">
                {stat.unit}
              </span>
            </div>
          </div>
