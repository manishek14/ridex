...
export function WalletBalance({ locale = "fa" }: { locale?: string }) {
  ...
  return (
    <div className="p-8 rounded-[32px] bg-fg text-bg relative overflow-hidden group" dir={isFa ? "rtl" : "ltr"}>
      ...
      <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
        ...
        <div className="flex flex-wrap gap-3">
          <Button 
            className="bg-bg text-fg hover:bg-bg/90 px-6 py-6 rounded-2xl shadow-xl flex items-center gap-2"
          >
            <Plus size={20} />
