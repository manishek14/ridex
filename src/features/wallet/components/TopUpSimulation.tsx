...
export function TopUpSimulation({ locale = "fa", onClose }: { locale?: string; onClose: () => void }) {
  ...
  return (
    <div className="p-6 bg-[var(--bg2)] border border-[var(--bdr)] rounded-[28px] shadow-2xl max-w-[400px] w-full" dir={isFa ? "rtl" : "ltr"}>
      <AnimatePresence mode="wait">
        {!isSuccess ? (
          <motion.div key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            <h3 className="text-xl font-black text-[var(--fg)] mb-6" style={{ fontFamily: isFa ? "Vazirmatn, sans-serif" : undefined }}>
            ...
            <div className="p-4 rounded-2xl bg-[var(--glass)] border border-[var(--bdr)] mb-6 flex items-center gap-3">
          ...
          >
            ...
            <h3 className="text-2xl font-black text-[var(--fg)] mb-2" style={{ fontFamily: isFa ? "Vazirmatn, sans-serif" : undefined }}>
