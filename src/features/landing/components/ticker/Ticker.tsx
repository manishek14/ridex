...
export function Ticker({ locale = "fa" }: TickerProps) {
  ...
  return (
    <div className="overflow-hidden border-t border-b border-bdr py-2 sm:py-2.5 bg-bg2">
      <div
      ...
      >
        {all.map((item, i) => (
          <span
            key={i}
            className="flex items-center gap-1.5 sm:gap-2.5 px-4 sm:px-6 md:px-[34px] text-[10px] sm:text-[11.5px] font-medium text-fg3 flex-shrink-0"
